...
/*
Package udp provides helper functions for packetizing sample data for
UDP transmission.
*/
package udp
...
// PacketWriteFn is a function type that writes the provided samples to
...
// NewPacketWriteFn creates a new UDPPacketWriteFn.
