...
/*
rspwav is a command-line utility that records to a stereo WAV file
the components of the a single stream of any RSP device.
	...
	-out string
			Write WAV file to specified path. (default "rsp.wav")
	-rsp2ant string
			a|b: RSP2 Antenna
